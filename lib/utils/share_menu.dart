    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('Share your event via', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Theme.of(context).colorScheme.secondary)),
          const SizedBox(height: 20),
          QrImage(
            data: widget.url,
          ...
          const SizedBox(height: 20),
          Text('or', style: TextStyle(color: Theme.of(context).colorScheme.onSurface)),
          const SizedBox(height: 20),
          TextButton(
            ...
            onPressed: () {
              SnackBar snackBar = SnackBar(
                ...
                content: Text('Copied link to clipboard!', style: TextStyle(color: Theme.of(context).colorScheme.background)),
              );
              Clipboard.setData(
                ClipboardData(
                  text: widget.url,
